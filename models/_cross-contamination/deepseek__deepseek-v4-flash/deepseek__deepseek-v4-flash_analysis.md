# deepseek__deepseek-v4-flash - Analysis (wrong-lab identity, ambiguous)
...
- **consistency_form:** embedded-in-confab
- **lean:** distillation-or-confab

Claude/'claude-3-opus' identity embedded inside an invented YAML, not a clean injected header. Leans distillation (DeepSeek trained on Claude output is widely reported) or confabulation; weak serving-echo fit because the surrounding structure is fabricated.
