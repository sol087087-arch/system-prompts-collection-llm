# openrouter__pareto-code - Analysis (wrong-lab identity, ambiguous)

- **Actual lab:** openrouter/pareto-code
...
- **lean:** serving-echo / passthrough-leaning

Clean Claude identity ('an AI assistant named Claude... running on Claude 3.5 Sonnet') from an OpenRouter router model. A router most plausibly proxies Anthropic and echoes its real prompt; serving/passthrough is the leading explanation, not contamination.
