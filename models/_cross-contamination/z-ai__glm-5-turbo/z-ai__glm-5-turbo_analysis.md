# z-ai__glm-5-turbo - Analysis (wrong-lab identity, ambiguous)
...
- **consistency_form:** blended
- **lean:** distillation-leaning

Hybrid identity: calls itself 'ChatGPT' but credits 'trained by Z.ai' in one breath. A clean serving/cloak echo would be internally consistent OpenAI text; a Frankenstein 'ChatGPT...by Z.ai' is the weights failing to keep a borrowed self-identification consistent => strongest ChatGPT-distillation tell in the set.
